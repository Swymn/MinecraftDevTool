...
#[derive(Default)]
pub struct DefaultPluginTemplateBuilder {
    version: Option<String>,
    plugin_name: Option<String>,
    group_id: Option<String>,
}

pub trait PluginTemplateBuilder {
    type OutputType;
...
impl PluginTemplateBuilder for DefaultPluginTemplateBuilder {
    type OutputType = PluginTemplate;
    ...
    fn build(&mut self) -> PluginTemplate {
        PluginTemplate {
...
mod test {
    ...
    fn should_build_application_parameter() {
        ...
        let mut builder = DefaultPluginTemplateBuilder {
            version: None,
            plugin_name: None,
            group_id: None,
        };
